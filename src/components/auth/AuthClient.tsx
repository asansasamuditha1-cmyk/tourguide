  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      if (mode === "register") {
        ...
        toast({ title: "Registration successful!", description: "Welcome to LankaGuide AI." });
        router.push("/profile");
      } else {
    ...
    <div className="flex justify-center items-center py-12">
      <Card className="w-full max-w-sm">
        <CardHeader>
          ...
          <CardDescription>
            {mode === "login" ? "Enter your email below to login to your account." : "Enter your details to create an account."}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
